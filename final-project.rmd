...
individual candidates that people contributed to.
...
Trump, Ted Cruz, Ben Carson) received fewer overall donations, but the median 
...
this reflected in the clustering of contribution amounts at $2700 and $5400. 
...
There is a very strong correlation between female gender and Democratic Party 
contributions. Other discoveries include how cluttered the Republican 
race was prior to primaries, the lack of Trump support prior to the Republican
Primary and the strong Bernie support prior to the Democratic National Convention.
...
ggplot(data=hill_v_trump, aes(x=contrib_month_year, y=total, group=cand_nm)) +
  ...
  facet_wrap(~gender)
```
Donations trends to Hillary vs. Trump were uniform in shape, but not in scale
...
actually donated more to Hillary!
...
I observed that Democratic indicators include high population density and female 
...
until after the DNC that his support fully dried up. This coincides with my 
